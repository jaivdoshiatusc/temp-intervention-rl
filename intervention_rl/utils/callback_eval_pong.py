...
class PongEvalCallback(BaseCallback):
    ...
    def create_frame(self):
        ...
        blocker_line = PongEvalCallback.PLAY_AREA[1] - self.catastrophe_clearance - self.blocker_clearance
        catastrophe_line = PongEvalCallback.PLAY_AREA[1] - self.catastrophe_clearance
