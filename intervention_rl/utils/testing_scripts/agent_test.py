...
class PongRollout:
    ...
    def load_model(self):
        ...
        self.model = PPO.load(self.model_path)  # Adjust based on your algorithm
    ...
    def run_rollout(self):
        ...
        for step in range(self.total_steps):
            ...
            # Extract the action as an integer
            action = int(action)  # Ensure it's an integer scalar
...
if __name__ == '__main__':
    # Example usage
    model_path = '/home1/jpdoshi/intervention-rl/intervention_rl/results/2024-11-05-14-06-47/e-pong_a-ppo_et-hirl_gae-0.9_ent-0.01_lr-0.0025_ns-128_s-31/agent/ppo_hirl_model_2500000_steps.zip'  # Provide the correct model path here
